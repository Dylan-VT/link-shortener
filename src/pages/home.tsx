    ...
    return (
        <div className="bg-primary w-screen h-screen">
            ...
            <div className="flex flex-wrap justify-center items-center h-1/8 mt-auto">
                <input onChange={handleUrlInput} className="rounded min-w-1/2 h-1/2 pl-2 mx-5 my-3 shadow" placeholder="https://your-url-to-shorten.com"/>
                
                <button onClick={handleShortenButton}className="
                rounded-lg px-3 h-1/2 bg-secondary-right-400 text-center flex items-center justify-center">
                    Shorten
                </button>
            </div>

            <div className="w-screen flex justify-center">
                <span className="rounded-md empty:px-0 px-2 py-2 bg-secondary-right-200 border-2 border-secondary-right-300">
                    {shortenedUrlAlert}
                </span>
            </div>
        </div>
